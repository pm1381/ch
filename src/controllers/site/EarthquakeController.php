...
use App\Entities\EarthquickInsurance;

class EarthquakeController extends SiteRefrenceController {
    ...
    public function create() {
        ...
        $classData = $this->makeClassData($insertData, EarthquickInsurance::class);
